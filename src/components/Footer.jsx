...
const Footer = () => {
    return (
        <footer id='footer' class="bg-dark pt-24 pb-12 dark:bg-black">
            <div class="container">
                <div class="flex flex-wrap items-center">
                    <div class="w-full px-4 mb-12 text-slate-300 font-medium
                md:w-1/3">
                        <h2 class="font-bold text-4xl text-white mb-5">Eko Setiyawan</h2>
                        <h3 class="font-bold text-2xl mb-2">Hubungi Saya</h3>
                        <p>ekosetiyawan@hotmail.com</p>
                        <p>Jl. Parangtritis km. 10 Pundong</p>
                    ...
                    <div class="w-full px-4 mb-12 md:w-1/3">
                        ...
                        <ul class="text-slate-300">
                            <li>
                                <a href="#beranda" class="inline-block text-base
                            hover:text-primary">Beranda</a>
                            </li>
                            <li>
                                <a href="#about" class="inline-block text-base
                            hover:text-primary">Tentang Saya</a>
                            </li>
                            <li>
                                <a href="#portfolio" class="inline-block text-base
                            hover:text-primary">Portfolio</a>
                            </li>
                            <li>
                                <a href="#clients" class="inline-block text-base
                            hover:text-primary">Clients</a>
                            </li>
                            <li>
                                <a href="#blog" class="inline-block text-base
